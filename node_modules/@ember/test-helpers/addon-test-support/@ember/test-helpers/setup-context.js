...
import { getDeprecationsForContext, getDeprecationsDuringCallbackForContext, } from './-internal/deprecations';
 ...
 * });
 */
export function getDeprecationsDuringCallback(callback) {
    const context = getContext();
    if (!context) {
        throw new Error('[@ember/test-helpers] could not get deprecations if no test context is currently active');
    }
