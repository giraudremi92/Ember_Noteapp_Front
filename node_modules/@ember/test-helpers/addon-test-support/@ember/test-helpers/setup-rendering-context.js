...
export default function setupRenderingContext(context) {
    ...
    return Promise.resolve()
        ...
        let renderDeprecationWrapper = function (template) {
            deprecate('Using this.render has been deprecated, consider using `render` imported from `@ember/test-helpers`.', false, {
        ...
        let clearRenderDeprecationWrapper = function () {
            deprecate('Using this.clearRender has been deprecated, consider using `clearRender` imported from `@ember/test-helpers`.', false, {
        ...
        Object.defineProperty(context, 'element', {
            ...
            value: global.EmberENV._APPLICATION_TEMPLATE_WRAPPER !== false
